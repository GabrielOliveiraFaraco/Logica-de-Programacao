def coletar_respostas(perguntas): # Função para coletar respostas do usuário
    respostas = []
...
def main(): # Função principal do programa
    ...
    areas = { # Dicionário com as áreas e suas respectivas perguntas
    ...
    resultados = {area: coletar_respostas(perguntas) for area, perguntas in areas.items()} # Coleta as respostas para cada área
